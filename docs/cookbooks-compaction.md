...
To run compaction on a topic, you need to use the [`topics compact`](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-admin/topics?id=compact) command for the [`pulsar-admin`](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-admin/) CLI tool. Here's an example:
