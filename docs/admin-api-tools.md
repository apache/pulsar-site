...
- Pulsar admin APIs 
  ...
  - [Java admin API](https://pulsar.apache.org/api/admin/): It’s a programmable interface written in Java.
   ...
   - [REST API](https://pulsar.apache.org/admin-rest-api/?version=@pulsar:version_number@): HTTP calls, which are made against the admin APIs provided by brokers. In addition, both the Java admin API and pulsar-admin CLI use the REST API.

- [pulsar-admin CLI](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-admin/): It’s a command-line tool and is available in the bin folder of your Pulsar installation.
