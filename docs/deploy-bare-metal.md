...
Currently, Pulsar is available for 64-bit **macOS**, **Linux**, and Pulsar is available with Docker in **Windows**. See [Running Pulsar In Docker](https://pulsar.apache.org/docs/next/getting-started-docker/) for deeper understanding. To use Pulsar, you need to install 64-bit JRE/JDK.
