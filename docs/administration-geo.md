...
For **non-partitioned topics**, there are two options: enable topic auto-creation at the broker level (the default) or in the namespace policy, or create the topic explicitly in each cluster.
