...
* [Example](io-debezium-source.md#example-of-db2)

* [Java class](https://github.com/apache/pulsar/blob/master/pulsar-io/debezium/db2/src/main/java/org/apache/pulsar/io/debezium/db2/DebeziumDB2Source.java)
