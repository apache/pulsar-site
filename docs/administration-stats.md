...
| earliestMsgPublishTimeInBacklog                  | The publish time of the earliest message in the backlog for the subscription (in milliseconds). Not reset upon restart                                                                                                                                               |
...
| backlogSize                                      | The size of backlog for this subscription (in bytes). Not reset upon restart                                                                                                                                                                                         |
| nonContiguousDeletedMessagesRanges               | The number of non-contiguous deleted messages ranges.                                                                                                                                                                                                                |
| nonContiguousDeletedMessagesRangesSerializedSize | The serialized size of non-contiguous deleted messages ranges.                                                                                                                                                                                                       |
