---
id: pulsar-4.2.2
title: Apache Pulsar 4.2.2
sidebar_label: Apache Pulsar 4.2.2
---
...
- [fix][broker][branch-4.2] URL-encode sub-name in Txn pending-ack topic [#25727](https://github.com/apache/pulsar/pull/25727) ([#25728](https://github.com/apache/pulsar/pull/25728))
...
- [fix][build][branch-4.2] Fix checkstyle issue after a previous cherry-pick
- [fix][build][branch-4.2] Fix compilation issue after backporting
- [fix][test][branch-4.2] Fix PersistentMessageExpiryMonitorTest

For the complete list, check the [full changelog](https://github.com/apache/pulsar/compare/v4.2.1...v4.2.2).
