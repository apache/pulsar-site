---
id: pulsar-4.2.3
title: Apache Pulsar 4.2.3
sidebar_label: Apache Pulsar 4.2.3
---
...
- [fix][sec][branch-4.2] Upgrade Jackson version to 2.18.8 ([#26099](https://github.com/apache/pulsar/pull/26099))
...
For the complete list, check the [full changelog](https://github.com/apache/pulsar/compare/v4.2.2...v4.2.3).
