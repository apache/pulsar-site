...
With the package management service enabled, you can [upload your function package](/reference/#/@pulsar:version_reference@/pulsar-admin/functions?id=upload) to the service and get the package URL. Thus you can create the function by setting `--jar`, `--py`, or `--go` to the package URL.
