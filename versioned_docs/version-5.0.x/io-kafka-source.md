...
4. Create a Kafka source connector on a Pulsar cluster using the [`pulsar-admin sources create`](/reference/#/@pulsar:version_reference@/pulsar-admin/sources?id=create) command.
