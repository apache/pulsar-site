...
Set topic policies | N/A | Refer to [Set topic-level dispatch rate](pathname:///admin-rest-api/?version=@pulsar:rest_api_version@/#operation/PersistentTopics_setDispatchRate). | Refer to [Set subscription-level dispatch rate](pathname:///admin-rest-api/?version=@pulsar:rest_api_version@/#operation/PersistentTopics_setSubscriptionDispatchRate).<br />It applies to all subscriptions in a topic.
