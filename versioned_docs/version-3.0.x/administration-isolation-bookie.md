...
For more information about the command `pulsar-admin namespaces set-bookie-affinity-group options`, see [Pulsar admin docs](/reference/#/@pulsar:version_reference@/pulsar-admin/).
