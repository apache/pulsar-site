...
#### Note
>
> Currently, the Pulsar schema registry is only available for the [Java client](pathname:///docs/client-libraries/java), [Go client](pathname:///docs/client-libraries/go), [Python client](pathname:///docs/client-libraries/python), and [C++ client](pathname:///docs/client-libraries/cpp).
