...
[Command-line tools](reference-cli-tools.md), such as [Pulsar-admin](/reference/#/@pulsar:version_reference@/pulsar-admin/), [Pulsar-perf](/reference/#/@pulsar:version_reference@/pulsar-perf/) and [Pulsar-client](/reference/#/@pulsar:version_reference@/pulsar-client/), use the `conf/client.conf` file in your Pulsar installation. To configure basic authentication in Pulsar CLI tools, you need to add the following parameters to the `conf/client.conf` file.
