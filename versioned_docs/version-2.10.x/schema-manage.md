...
Use the [`pulsar-admin topicPolicies remove-schema-compatibility-strategy`](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-admin/topicPolicies?id=remove-schema-compatibility-strategy) command. 
...
Use the [`pulsar-admin namespaces set-schema-compatibility-strategy`](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-admin/topicPolicies?id=set-schema-compatibility-strategy) command. 
