...
1. for [Command-line tools](reference-cli-tools.md) like [`pulsar-admin`](/reference/#/@pulsar:version_reference@/), [`pulsar-perf`](/reference/#/@pulsar:version_reference@/), and [`pulsar-client`](/reference/#/@pulsar:version_reference@/), set the `conf/client.conf` file in a Pulsar installation.
