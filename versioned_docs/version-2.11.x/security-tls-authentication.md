...
1. for [Command-line tools](reference-cli-tools.md) like [`pulsar-admin`](pathname:///reference/#/@pulsar:version_reference@/), [`pulsar-perf`](pathname:///reference/#/@pulsar:version_reference@/), and [`pulsar-client`](pathname:///reference/#/@pulsar:version_reference@/), set the `conf/client.conf` file in a Pulsar installation.
