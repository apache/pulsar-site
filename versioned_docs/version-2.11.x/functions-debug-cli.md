...
With [Pulsar Functions CLI](pathname:///reference/#/@pulsar:version_reference@/pulsar-admin/functions), you can debug Pulsar Functions with the following subcommands:
