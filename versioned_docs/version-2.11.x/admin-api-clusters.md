...
* The `clusters` command of the [`pulsar-admin`](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-admin) tool
...
Use the [`update-peer-clusters`](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-admin/clusters?id=update-peer-clusters) subcommand and specify the list of peer-cluster names.
