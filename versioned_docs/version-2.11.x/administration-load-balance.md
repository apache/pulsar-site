...
Alternatively, you can override the value when you create a new namespace using [Pulsar admin CLI](/reference/#/@pulsar:version_reference@/pulsar-admin/):
...
You can also view, update, and delete domains under a specific cluster. For more information, refer to [Pulsar admin doc](/reference/#/@pulsar:version_reference@/pulsar-admin/).
...
For more information about `anti-affinity-group` related commands, refer to [Pulsar admin doc](/reference/#/@pulsar:version_reference@/pulsar-admin/).
