...
* To start a function worker in the foreground, you can use the [`pulsar-admin`](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-admin) CLI as follows.
