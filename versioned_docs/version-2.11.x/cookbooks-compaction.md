...
To run compaction on a topic, you need to use the [`topics compact`](/reference/#/@pulsar:version_reference@/pulsar-admin/topics?id=compact) command using the [`pulsar-admin`](/reference/#/@pulsar:version_reference@/pulsar-admin/) CLI tool. Here's an example:
