...
For more information about these options, refer to [producer configurations](pathname:///docs/client-libraries/java#configure-producer) and [consumer configurations](pathname:///docs/client-libraries/java#configure-consumer).
