...
In addition to the required configurations in the `conf/client.conf` file, you need to configure more parameters in the `conf/broker.conf` file to enable TLS encryption on WebSocket service. For more details, see [security settings for WebSocket](pathname:///docs/client-libraries/websocket#security-settings).
...
[Command-line tools](reference-cli-tools.md) like [`pulsar-admin`](/reference/#/@pulsar:version_reference@/), [`pulsar-perf`](/reference/#/@pulsar:version_reference@/), and [`pulsar-client`](/reference/#/@pulsar:version_reference@/) use the `conf/client.conf` config file in a Pulsar installation.
...
For [Command-line tools](reference-cli-tools.md) like [`pulsar-admin`](/reference/#/@pulsar:version_reference@/), [`pulsar-perf`](/reference/#/@pulsar:version_reference@/), and [`pulsar-client`](/reference/#/@pulsar:version_reference@/), use the `conf/client.conf` config file in a Pulsar installation.
