...
With the [`pulsar-admin`](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-admin) CLI, you can send messages to functions without using the [`pulsar-client`](https://pulsar.apache.org/reference/#/@pulsar:version_origin@/pulsar-client) tool or a language-specific client library.
