...
If you want to deploy and trigger Python user-defined functions, you need to install [the pulsar python client](pathname:///docs/client-libraries/python) on all the machines running [functions workers](functions-worker.md).
