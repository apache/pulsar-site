...
The easiest way to use the dashboard is to run it inside a Docker container. A {@inject: github:Dockerfile:/dashboard/Dockerfile} to generate the image is provided.
