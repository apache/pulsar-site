...
**Java Admin API**| The `functions` method of the [PulsarAdmin](@pulsar:javadoc:admin@/org/apache/pulsar/client/admin/PulsarAdmin) object in the [Java API](pathname:///docs/client-libraries/java).
