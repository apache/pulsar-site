...
* The `namespaces` method of the [PulsarAdmin](/api/admin/org/apache/pulsar/client/admin/PulsarAdmin) object in the [Java API](pathname:///docs/client-libraries/java)
