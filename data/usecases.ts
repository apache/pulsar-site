...
const usecases: UseCase[] = [
    ...
    },
    {
        ...
        smalltext: "In a micro-services architecture, there is a need to communicate between services constantly. One way of doing it is direct API calls, which require",
