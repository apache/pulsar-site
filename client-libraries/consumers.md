...
<TabItem value="Java">
   ...
   Async receive operations return a [Message](@pulsar:javadoc:client@/org/apache/pulsar/client/api/Message) wrapped inside of a [`CompletableFuture`](http://www.baeldung.com/java-completablefuture).
