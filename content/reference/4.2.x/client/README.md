...
- [Client configurations](/4.2.x/client/client-configuration-client)
- [Producer configurations](/4.2.x/client/client-configuration-producer)
- [Consumer configurations](/4.2.x/client/client-configuration-consumer)
- [Reader configurations](/4.2.x/client/client-configuration-reader)
