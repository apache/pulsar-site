...
Produce messages to a specified topic using the v4 client


```shell
$ pulsar-client produce-v4 [options]
```
...
Consume messages from a specified topic using the v4 client


```shell
$ pulsar-client consume-v4 [options]
```
...
Read messages from a specified topic using the v4 client


```shell
$ pulsar-client read-v4 [options]
```
