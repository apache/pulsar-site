...
| `-ml, --memory-limit` | Configure the Pulsar client memory limit (eg: 32M, 64M). Defaults to half of the JVM's max direct memory. Use 0 to disable the limit.|4670783488|
...
Test pulsar producer performance using the v4 client.


```shell
$ pulsar-perf produce-v4 [options]
```
...
Test pulsar consumer performance using the v4 client.


```shell
$ pulsar-perf consume-v4 [options]
```
...
Test pulsar transaction performance using the v4 client.


```shell
$ pulsar-perf transaction-v4 [options]
```
...
Test pulsar reader performance using the v4 client.


```shell
$ pulsar-perf read-v4 [options]
```
