---
id: version-2.6.4-reference-configuration
...
|managedLedgerMaxEntriesPerLedger|  Max number of entries to append to a ledger before triggering a rollover. A ledger rollover is triggered on these conditions: <ul><li>Either the max rollover time has been reached</li><li>or max entries have been written to the ledger and at least min-time has passed</li></ul>|50000|
